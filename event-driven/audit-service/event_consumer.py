...
class EventConsumer:
            ...
            try:
                ...
                for stream_name, msgs in messages:
                    for msg_id, fields in msgs:
                        self._process_message(stream_name.decode(), msg_id.decode(), fields)
                ...
                for pending in pending_messages:
                    ...
                    if msgs:
                        ...
                        self._process_message(stream, msg_id_str.decode(), fields)
    ...
    def _process_message(self, stream: str, msg_id: str, fields: Dict[bytes, bytes]):
        ...
        try:
            ...
            if event_type in self.event_handlers:
                ...
                # Acquitter quand même pour éviter la répétition
                self.redis_client.xack(stream, self.consumer_group, msg_id)
