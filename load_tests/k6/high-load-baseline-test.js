/**
 * Test baseline avec HAUTE CHARGE (100 VUs)
 */
...
export default function () {
  ...
  const performancesSuccess = check(response, {
    ...
    'stores performances response time < 15s': (r) => r.timings.duration < 15000,
...
export function handleSummary(data) {
  ...
  return {
    [`load_test_results/high_load_baseline_${timestamp}.json`]: JSON.stringify(data, null, 2),
  };
} 